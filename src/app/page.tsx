  ...
  return (
    <div>
        ...
        <div className="flex flex-col">
            <div className="mt-4">
              <p className="font-montserrat text-base tracking-wide">I am a <span className="highlights">Senior WordPress Developer</span> interested in <span className="highlights">working with organizations</span> making a positive <span className="highlights">social or environmental impact</span>.</p>
            </div>
