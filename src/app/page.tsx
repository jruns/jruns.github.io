  ...
  return (
    <div className="md:container flex flex-col mx-4 sm:mx-8 md:mx-auto">
        ...
        <div className="mt-3 mb-6 flex flex-col">
            ...
            <p className="mt-4 font-poppins text-base">I have been working as a full-time Senior Web Developer on a team maintaining and developing over 40 large-scale WordPress sites, while also creating and managing my own WordPress websites on the side. Before that I worked with SharePoint for over 10 years and was a Senior SharePoint Developer. I am currently focused on finding work at an organization making positive changes in the world.</p>  
            <p className="mt-4 sm:mt-2 font-poppins text-base">I am experienced with WordPress, PHP, JavaScript, jQuery, CSS/SASS, Bootstrap, TailwindCSS, the WP REST API, WordPress hooks and filters, developing custom WP plugins and themes with external API integrations, MySQL and optimizing database queries, DNS and server administration, site monitoring, caching, CDNs (Cloudflare and Fastly), Core Web Vitals monitoring, performance optimization, accessibility, responsive design, Figma, Google Tag Manager, Google Analytics, SEO, Git, Docker, CI/CD tools, local environments, and much more. I also have experience with Drupal, React, Vue.js, Next.js, and Python.</p>
