  ...
  return (
    <div className="md:container flex flex-col mx-4 sm:mx-8 md:mx-auto">
        ...
        <div className="mt-3 mb-6 flex flex-col">
            ...
            <p className="mt-4 font-poppins text-base">I have been developing for the Web since the late 90s, back when GeoCities was a thing, and I have been developing with WordPress since 2004. I have been working as a full-time Senior Web Developer while also creating and managing my own WordPress websites on the side. Before that I worked with SharePoint for over 10 years and was a Senior SharePoint Developer.</p>
            <p className="mt-4 sm:mt-2 font-poppins text-base">I have a curiosity and love of learning that helps me to learn whatever is needed. I&apos;m as comfortable working on the front-end as I am on the back-end, and I enjoy working on a variety of projects. I am experienced with PHP, JavaScript, CSS/SASS, MySQL, WordPress, DNS and server administration, site monitoring, caching, Core Web Vitals and page optimization, accessibility, responsive design, Figma, Google Tag Manager, Google Analytics, SEO, Cloudflare, CI/CD tools, local environments, and much more. I also have experience with Drupal, React, Vue.js, Next.js, and Python.</p>
            <p className="mt-4 sm:mt-2 font-poppins text-base">I have extensive experience managing dozens of websites and technical infrastructure, and coordinating with various department stakeholders. I enjoy distilling the benefits and drawbacks of technology to inform decisions and guide others through the use of those tools. And I have a special interest in improving performance and security, often suggesting and implementing opportunities to improve both.</p>
            <p className="mt-4 sm:mt-2 font-poppins text-base">I am skilled in planning projects and coordinating tasks, and I actually enjoy writing and maintaining technical and end-user documentation. I regularly collaborate with stakeholders to refine requirements and translate them into technical solutions. I also have experience evaluating tools and providing recommendations based on needs and budgets.</p>
